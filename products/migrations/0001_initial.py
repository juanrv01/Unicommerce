    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', cloudinary.models.CloudinaryField(default='default.jpg', max_length=255, validators=[products.models.validate_image_size, products.models.validate_image_extension], verbose_name='images')),
